...
function Landing() {
    ...
    useEffect(() => {
        setColumns([
            ...
            {
                name: 'Section',
                selector: row => row.section?.length,
                maxWidth: '100px'
            },
            {
                cell: (row) => <>
                ...
                {isAdd ?
                    ...
                    <Card>
                        <Row className='mb-4'>
                            <Col md={11}>
                                <CardBody>
                                    <CardTitle><b>Pages</b></CardTitle>
                                    <CardSubtitle>Pages you have created before. All the Page can only be opened by <code>url</code> only.</CardSubtitle>
                                </CardBody>
                            </Col>
                            {
