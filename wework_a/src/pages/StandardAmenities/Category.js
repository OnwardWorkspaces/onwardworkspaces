...
function WorkCategory() {
        ...
        setColumns([
            ...
            },
            {
                ...
                style={{ backgroundColor: Utils.themeColor, marginRight: 10, padding: 5, paddingLeft: 8, paddingRight: 8, border: 'none' }}><span className="mdi mdi-eye" style={{ fontSize: 20 }}></span></Button> */}
                    {checkPermission('standardAmenitiesCategory', 'update') &&
                    ...
                    {checkPermission('standardAmenitiesCategory', 'delete') &&
    ...
    const getData = () => {
        if (!loading) {
            setLoading(true);
            get("standard/category", { token: user?.token })
                .then(res => {
                    setLoading(false);
            ...
            <div className="main main-app p-3 p-lg-4">
                <Card>
                    <Row className='mb-4'>
                        <Col md={11}>
                            <CardBody>
                                <CardTitle><b>Standard Amenities Category</b></CardTitle>
                                <CardSubtitle>Categories you have added before</CardSubtitle>
                            </CardBody>
                        </Col>
                        {checkPermission('standardAmenitiesCategory', 'write') &&
                            <Col md={1}>
