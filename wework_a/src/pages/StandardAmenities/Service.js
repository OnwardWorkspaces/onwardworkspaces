...
function StandService() {
        ...
        setColumns([
            ...
            },
            {
                ...
                style={{ backgroundColor: Utils.themeColor, marginRight: 10, padding: 5, paddingLeft: 8, paddingRight: 8, border: 'none' }}><span className="mdi mdi-eye" style={{ fontSize: 20 }}></span></Button> */}
                    {checkPermission('standardAmenitiesService', 'update') &&
                    ...
                    {checkPermission('standardAmenitiesService', 'delete') &&
    ...
    const getCats = () => {
        get("standard/category/list", { token: user?.token })
            .then(res => {
                if (res?.statusCode == 200) {
                    setCats(res?.data);
                }
            ...
            <div className="main main-app p-3 p-lg-4">
                <Card>
                    <Row className='mb-4'>
                        <Col md={11}>
                            <CardBody>
                                <CardTitle><b>Standard Amenities Service</b></CardTitle>
                                <CardSubtitle>Services you have added before</CardSubtitle>
                            </CardBody>
                        </Col>
                        {checkPermission('standardAmenitiesService', 'write') &&
                            <Col md={1}>
