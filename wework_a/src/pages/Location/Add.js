        ...
        if (!loading) {
            ...
            await Promise.all(gallery.map(async (item) => {
                if (item?.substring(0, 4) == 'data') {
                    ...
                    const form = new FormData();
                    form.append("image", tempObj);
                    const uploadRes = await upload("location/image_upload", form);
                    if (uploadRes?.statusCode == 200)
            ...
            <div className="main main-app p-3 p-lg-4">
                ...
                <Card>
                    <CardBody>
                        <Row>
                            <Col md={10}>
                                <CardTitle className='mb-4'><b>{currentData?._id ? 'Update Location' : 'Add New Location'}</b></CardTitle>
                            </Col>
                            <Col>
                        ...
                        <AvForm onValidSubmit={handleValidSubmit}>
                            ...
                            <div className='divider' />
                            <Label><h5>NearBy Location Headings</h5></Label>
                            <Row>
                                <Col lg={6} md={6}>
                                    <div className='mb-4'>
                                        <AvField
