    ...
    return (
        <>
            ...
            {data?.section?.length ?
                <section className='our-service-section'>
                    <div className='section-divider'>
                        <div className='child-1 child-div'>
                            <div className='heading-section' >
                                <h5>{data?.section[0]?.title}</h5>
                            </div>
                            <div class="card-service card-service-w" style={{ backgroundImage: `url(${data?.section[0]?.image})` }}>
                                <div className='card-service-details'>
                                    <h3 className='heading padding_bottom mb-0'>{data?.section[0]?.title}</h3>
                                    <ul class="card-service-list">

                                        <p className='paragraph' style={{ whiteSpace: 'pre-line' }}>{data?.section[0]?.desc}</p>
                                    </ul>
                                </div>
                            </div>

                        </div>
                        <div className='child-2 child-div'>
                            <div className='heading-section'>
                                <h5>{data?.section[1]?.title}</h5>
                            </div>
                            <div class="card-service card-service-b" style={{ backgroundImage: `url(${data?.section[1]?.image})` }}>
                                <div className='card-service-details'>
                                    <h3 className='heading padding_bottom mb-0'>{data?.section[1]?.title}</h3>

                                    <ul class="card-service-list">
                                        <p className='paragraph' style={{ whiteSpace: 'pre-line' }}>{data?.section[1]?.desc}</p>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className='child-3 child-div'>
                            ...
                            <div class="card-service card-service-w" style={{ backgroundImage: `url(${data?.section[2]?.image})` }}>
                                <div className='card-service-details'>
                                    <h3 className='heading padding_bottom mb-0'>{data?.section[2]?.title}</h3>

                                    <ul class="card-service-list">
                                        <p className='paragraph' style={{ whiteSpace: 'pre-line' }}>{data?.section[2]?.desc}</p>
                                    </ul>
                                </div>
                            </div>

                        </div>
                        <div className='child-4 child-div'>
                            <div className='heading-section'>
                                <h5>{data?.section[3]?.title}</h5>
                            </div>
                            <div class="card-service card-service-b" style={{ backgroundImage: `url(${data?.section[3]?.image})` }}>
                                <div className='card-service-details'>
                                    <h3 className='heading padding_bottom mb-0'>{data?.section[3]?.title}</h3>

                                    <ul class="card-service-list">
                                        <p className='paragraph' style={{ whiteSpace: 'pre-line' }}>{data?.section[3]?.desc}</p>
                                    </ul>
                                </div>
                            </div>

                        </div>
                        <div className='child-5 child-div'>
                            <div className='heading-section'>
                                <h5>{data?.section[4]?.title}</h5>
                            </div>
                            <div class="card-service card-service-w" style={{ backgroundImage: `url(${data?.section[4]?.image})` }}>
                                <div className='card-service-details'>
                                    <h3 className='heading padding_bottom mb-0'>{data?.section[4]?.title}</h3>

                                    <ul class="card-service-list">
                                        <p className='paragraph' style={{ whiteSpace: 'pre-line' }}>{data?.section[4]?.desc}</p>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className='child-6'>
                            <h4>OUR <br />
                                SOLUTIONS</h4>
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb breadcrumb_new">
                                    <li className="breadcrumb-item"><Link to="/">Home</Link></li>
                                    <li className="breadcrumb-item active" aria-current="page">Our Solutions</li>
                                </ol>
                            </nav>
                                ...
                                <section className='about-section about_section_order'>
                                    <div className='about-left-section'>
                                        <div className='header-title'>
                                            <h3 className='heading padding_bottom mb-0'>{item?.title}</h3>
            ...
            {data && data?.ameni?.length ?
                <section className='amenities-section top-0 bottom-0 padding-left-right mt-5'>
                    <div className='clients_box'>
                        <div className='heading-title'>
                            <h4 className='heading text-center  gallery_slider_heading workspaces padding_bottom'>Amenities</h4>
                        </div>
                    </div>
                    <Row>
                        {data?.ameni?.map((item) => (
                            <Col lg={2} md={3} sm={4} xs={6}>
                                <div className='amenities-box'>
                                    <div className='amenities_img'>
                                        <img src={item?.image ? item?.image : require('../../assets/images/spatial_audio_off.png')} alt='spatial_audio_off' />
                                    </div>
                ...
                : null}
            {data?.form?.length ?
                <section className="requirement-sectio requirement_section_mb-0 top bottom padding-left-right" id="connect">
                        ...
                        <Row>
                            ...
                            <Col lg={6}>
                                <div className='left-section get_form'>
                                    <h4 className='heading requirement-heading padding_bottom mb-0'>{data?.form[0]?.heading}</h4>
                                    <p className='paragraph mt-0'>{data?.form[0]?.desc}</p>
            ...
            {data?.clientale?.length ?
                <section className='clients-section clients_section_ mt-0 top-0 bottom-0 padding-left-right'>
                    <div className='clients_box'>
                        <div className='heading-title'>
            ...
            {data && data?.FAQ?.length ?
                <section className="fqa-section top-0 bottom padding-left-right">
                    <div className='faq_box'>
                        <div className='heading-title'>
                            <h4 className='heading text-center workspaces padding_bottom mb-0'>Frequently asked questions</h4>
