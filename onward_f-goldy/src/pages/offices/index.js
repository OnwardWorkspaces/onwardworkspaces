...
export default function Property() {
    ...
    const getData = () => {
        if (!loading) {
            setLoading(true);
            get(`office/title?title=${params.title}`)
                .then(res => {
                    setLoading(false);
    ...
    return (
        <>
            ...
            {data && data?.clientale?.length ?
                ...
                : null}
            {/* amenities */}
            {/* <section className='amenities-section top-0 bottom padding-left-right'>
                <div className='heading-title'>
            ...
            {data?.lat ?
                <section className='onward-workspaces-offerings top-0 bottom padding-left-right'>
                    <div className='workspaces-slider'>
                        <div className='heading-title'>
                            <h4 className='heading text-center workspaces'>Location</h4>
            ...
            {data?.suggest?.length ?
                <section className='onward-workspaces-offerings top-0 bottom padding-left-right'>
                    <div className='workspaces-slider'>
                        <div className='heading-title'>
                            <h2 className='heading text-center padding_bottom workspaces'>{data?.offHead ? data?.offHead : "Offices"}</h2>
                            ...
                            data?.suggest?.length <= 3 ?
                                ...
                                <div className='slider-section'>
                                    ...
                                    >
                                        {data?.suggest?.map((item) => (
                                            <SwiperSlide key={item?._id}>
                                                <Link to={`/property/${parseTitle(item?.path)}`} className='text-decoration-none'>
                                                    <div className='slider-item'>
                                                        <div className='item-image item-category-img'>
                                                            <img src={item?.images?.length ? item?.images[0] : require('../../assets/images/item.png')} alt={item?.title} />
                                                        </div>
                            ...
                            <Col lg={6}>
                                <div className='right-section'>
                                    <img
                                        ...
                                        src={data?.form[0]?.image ? data?.form[0]?.image : require('../../assets/images/form-img.png')} alt='form-img' />
                                </div>
                            </Col>
                            <Col lg={6}>
                                <div className='left-section get_form'>
                ...
                <section className='onward-workspaces-offerings top-0 gallery_section gallery_section_inner bottom-0 padding-left-right'>
                    <div className='workspaces-slider'>
                        <div className='heading-title'>
                            ...
                            <p className='paragraph' style={{ whiteSpace: 'pre-line' }}>{data?.galPara ? data?.galPara : ""}</p>
                        </div>
                        {
