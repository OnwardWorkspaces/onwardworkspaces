...
router.get("/", authMiddleware, async (req, res) => {
    try {
        let users = await officeController.getDataAdmin(req);
...
router.get("/list", authMiddleware, async (req, res) => {
    try {
        let users = await officeController.getData(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        console.log('error while getting users', error);
...
router.get("/drop", authMiddleware, async (req, res) => {
    try {
        let users = await officeController.getDrop(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        console.log('error while getting users', error);
...
router.get("/title", async (req, res) => {
    try {
        let users = await officeController.getDataByTitle(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        console.log('error while getting users', error);
...
//     try {
//         let user = await officeController.getUserById(req);
...
router.post("/", authMiddleware, async (req, res) => {
    try {
        let users = await officeController.addData(req);
        let code = users.statusCode;
...
router.put("/", authMiddleware, async (req, res) => {
    try {
        let users = await officeController.updateData(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        res.status(500).send({
...
router.delete("/", authMiddleware, async (req, res) => {
    try {
        let users = await officeController.removeData(req);
        let code = users.statusCode;
        // delete users.statusCode;
        res.status(code).send(users);
    } catch (error) {
...
//     try {
//         let users = await officeController.banUser(req);
//         let code = users.statusCode;
//         // delete users.statusCode;
//         res.status(code).send(users);
//     } catch (error) {
...
router.post("/image_upload", async(req, res)=>{
    try{
        let image = await officeController.imageUpload(req);
