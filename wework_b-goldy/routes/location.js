...
router.get("/", authMiddleware, async (req, res) => {
    try {
        let users = await locationController.getDataAdmin(req);
...
router.get("/list", authMiddleware, async (req, res) => {
    try {
        let users = await locationController.getData(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        console.log('error while getting users', error);
...
router.get("/drop", authMiddleware, async (req, res) => {
    try {
        let users = await locationController.getDrop(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        console.log('error while getting users', error);
...
//     try {
//         let user = await locationController.getUserById(req);
...
router.get("/title", async (req, res) => {
    try {
        let users = await locationController.getDataByTitle(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        console.log('error while getting users', error);
...
router.post("/", authMiddleware, async (req, res) => {
    try {
        let users = await locationController.addData(req);
        let code = users.statusCode;
...
router.put("/", authMiddleware, async (req, res) => {
    try {
        let users = await locationController.updateData(req);
        let code = users.statusCode;
        res.status(code).send(users);
    } catch (error) {
        res.status(500).send({
...
router.delete("/", authMiddleware, async (req, res) => {
    try {
        let users = await locationController.removeData(req);
        let code = users.statusCode;
        // delete users.statusCode;
        res.status(code).send(users);
    } catch (error) {
...
router.post("/image_upload", async(req, res)=>{
    try{
        let image = await locationController.imageUpload(req);
